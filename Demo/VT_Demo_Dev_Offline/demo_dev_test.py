...
#TXT_FILE_DIR = '/home/r1-user/code_sh/new_new/attention-target-detection/data/demo/pose.txt'
JSON_FILES = '/home/r1-user/code_sh/testset/board_images_human_openpose_json/*.json'
FRAMES_DIR = '/home/r1-user/code_sh/testset/board_images_human'
...
def run():
    ...
    for j in range(len(listOfJson)):
        ...
        df = pd.read_csv(line_to_write, names=column_names, index_col=0)
